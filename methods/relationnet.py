...
class RelationNet(MetaTemplate):
    ...
    def set_forward_adaptation(self,x,is_feature = True, fine_tune_epochs = 100, firth_c=None): #overwrite parent function
        ...
        for epoch in range(fine_tune_epochs):
            ...
            sub_x = torch.Tensor(sub_x).to(device_name)
            if self.change_way:
            ...
            if firth_c:
                ...
                loss_firth = (-firth_c) * logp_hat.mean()
