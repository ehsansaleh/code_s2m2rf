...
class MetaTemplate(nn.Module):
    ...
    def set_forward_adaptation(self, x, is_feature = True, fine_tune_epochs = 100, firth_c=None): #further adaptation, default is fixing feature and train a new softmax clasifier
